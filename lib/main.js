...
var start1 = document.getElementById('start-1');
var start2 = document.getElementById('start-2');
var stop1 = document.getElementById('stop-1');
var stop2Elemnt = document.getElementById('stop-2');

function setHour() {
  var daily = document.getElementById('daily-hours').value;

  var morning = subtractTime(stop1.value, start1.value);
